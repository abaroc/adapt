...
define(function(require) {
  ...
  var EditorMenuView = require('./editorMenuView');
  var EditorPageView = require('./editorPageView');
  ...
  var EditorView = EditorOriginView.extend({
    ...
    preRender: function(options) {
      ...
      this.listenTo(Origin, {
        ...
        'sidebar:action:download': function(event) {
          this.validateProject(this.downloadProject);
        },
        'sidebar:action:preview': function(event) {
        ...
        'sidebar:action:export': function(event) {
